...
Thankfully our Marathon Training turned out surprisingly successful! (Haven't run since [__15 years ago__](https://en.wikipedia.org/wiki/Individual_physical_proficiency_test))
...
Since I'm running so slowly: Let's make some videos during our runs and races! I'm extremely fortunate to run in all these beautiful places...
...
1.  _Toenails are turning blue / black / purple!_
    ...
    If the Toe Nail grows away from the Nail Bed (because of a scab or blister underneath): Use a Nail File to file away the gnarly bits.
